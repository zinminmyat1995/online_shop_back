...
use App\Http\Controllers\ApiControllers\UserRegistrationController;
...
Route::post('/menu-type/register', [MenuController::class, "addMenuType"]);
Route::get('/menu-type/search', [MenuController::class, "search"]);
Route::delete('/menu-type/remove', [MenuController::class, "removeMenuType"]);
Route::post('/meat-type/register', [MenuController::class, "addMeatType"]);
Route::get('/meat-type/search', [MenuController::class, "searchMeat"]);
Route::delete('/meat-type/remove', [MenuController::class, "removeMeatType"]);
Route::post('/menu/register',[MenuController::class,"menuRegister"]);
Route::post('/user/login',[UserRegistrationController::class,"login"]);
